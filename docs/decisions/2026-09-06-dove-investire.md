...
- ~~La licenza del codice e la pubblicazione del repository~~ **Decise l'8 settembre 2026:** repository pubblico, licenza MIT (vedi "Aggiornamenti").
- Se e quando candidare a un Progress Prize: **deciso l'8 settembre 2026** di lavorare fino a fine mese (piano E04) e inviare una candidatura entro il 30 settembre 2026 con ciò che sarà congelato il 21; l'invio lo fa Matteo.
...
- 2026-09-08 — **Decisioni di Matteo:** (1) fusione di `e03-socio` in `main` (commit `80a0ed7`); (2) repository **pubblico** con licenza **MIT**, subito, perché la priorità su un risultato la dà la pubblicazione e non il modulo di candidatura, e perché il rilascio anticipato è il primo criterio dei Progress Prizes; il repository non ridistribuisce dati dei rotoli; (3) il seguito di E03 è **E04, allineamento locale della profondità senza label** ([piano](../plans/2026-09-08-e04-allineamento-locale-profondita.md)): dall'avviso allo strumento, in cinque gradini dal basso (località, oracolo, stimatore senza label, mosaico, verifica finale su w029 in E05), zero GPU nella prima versione; le condizioni di ripensamento del quarto caso si leggono così: lo stadio resta rendering e profondità, E04 è ridefinito rispetto alla formulazione originaria (confronto fra modelli a pesi fissi) perché E03 ha mostrato dove si perde; (4) candidatura Progress Prize entro il 30 settembre 2026 con quanto congelato il 21; la registrazione Discord riguarda solo il Grand Prize e resta facoltativa.
