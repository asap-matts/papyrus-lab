...
3. **E02 (prossimo)**: congelare dati di sviluppo e verifica, baseline e metriche, usando R02–R05 del registro community; attenzione alle due trappole del dataset `ink_9um` (doppia rappresentazione, nomi non allineati). Il piano E02 va scritto sul commit corrente e revisionato prima dell'esecuzione. Gestione: Matteo; al socio compiti puntuali (il suo account Kaggle e il Mac sono ora collaudati).
