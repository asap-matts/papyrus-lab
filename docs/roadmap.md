...
| F3 — Progettazione dei test | **E02-R01 eseguito il 7 settembre 2026** ([scheda](reports/2026-09-07-e02-r01.md), [manifest](reports/2026-09-07-e02-r01-manifest.json), [piano](plans/2026-09-06-e02-costruire-il-metro.md)): metro intra-segmento congelato — inventario di `ink_9um` (29 rappresentazioni, 24 segmenti fisici), tre maschere ufficiali mai usate per il training (721.550 pixel), divisione sviluppo (w016, 0814) / verifica sigillata (w029, fino a E05), baseline E00 misurata per segmento e per strato di distanza, soglia congelata τ\* = 91, tre revisioni Codex. **Gate G3 proposto a Matteo** | Campioni, baseline, controlli, budget, metriche e stop definiti |
