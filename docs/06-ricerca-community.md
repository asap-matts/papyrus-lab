...
| R02 | [khj1222/vesuvius-challenge](https://github.com/khj1222/vesuvius-challenge): strumenti di valutazione che riservano intere regioni annotate, confrontano checkpoint e registrano risultati per regione. | Priorità alta per E02: verificare maschere e separazione sul nostro campione. La variabilità misurata dall'autore non è una soglia universale; creare una nuova maschera non rende indipendente un checkpoint già addestrato su quell'area. |
