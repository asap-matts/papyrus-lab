...
La pagina dei premi, riletta il 7 settembre 2026, indica come prossima scadenza dei Progress Prizes il **30 settembre 2026, 23:59 Pacific** (in precedenza mostrava il 31 agosto 2026, superato); criteri e condizioni sono riportati nella [nota di intake](reports/2026-09-07-intake-dove-investire.md). Ricontrollare la pagina prima di ogni candidatura. La clausola Discord è esplicita nella sezione Grand Prize e, alla rilettura del 7 settembre 2026, non compare nella sezione Progress Prizes né nei Terms and Conditions; questi ultimi richiedono l'apertura del codice con licenza permissiva per accettare il premio, non al momento della submission. Per i premi di scoperta è previsto di attendere l'annuncio prima di rendere pubblica la scoperta. Codice e materiali dovranno rispettare le condizioni di apertura e le licenze applicabili. [Fonte](https://scrollprize.org/prizes).
